...
function Feed({personal}) {
  ...
  return (
    <div className="feed flex flex-col w-full bg-gradient-to-t from-blue-200 to-sky-200 h-screen">
      <div className="flex top-0 p-8 bg-gray-900 feed_header shadow-2xl">
        <h2 className="text-2xl text-slate-300">Profile</h2>
      </div>
